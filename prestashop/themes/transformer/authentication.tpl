...
{literal}
	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html'}" method="post" id="create-account_form" class="std">
		<fieldset class="block">
			...
			<div class="form_content clearfix">
                ...
                <ul class="wrapper_block">
                    <li>
                        ...
                        <div class="input-box">
                            <input type="text" id="email_create" name="email_create" value="{if isset($smarty.post.email_create)}{$smarty.post.email_create|stripslashes}{/if}" class="account_input input-text" />
                        </div>
                    </li>
                </ul>
			</div>
			<div class="submit clearfix">
				...
				<input type="submit" id="SubmitCreate" name="SubmitCreate" class="button_large btn_primary btn-block" value="{l s='Create an account'}" />
	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html'}" method="post" id="login_form" class="std">
		<fieldset class="block">
			...
			<div class="form_content clearfix">
                <p class="mar_b1">{l s='If you have an account with us, please log in.'}</p>
                <ul class="wrapper_block">
                    <li>
                        <label for="email" class="required"><em>*</em>{l s='Email address'}</label>
                        <div class="input-box">
                            <input type="text" id="email" name="email" value="{if isset($smarty.post.email)}{$smarty.post.email|stripslashes}{/if}" class="account_input input-text" />
                        </div>
                    </li>
                    <li>
                        <label for="passwd" class="required"><em>*</em>{l s='Password'}</label>
                        <div class="input-box">
                            <input type="password" id="passwd" name="passwd" value="{if isset($smarty.post.passwd)}{$smarty.post.passwd|stripslashes}{/if}" class="account_input input-text" />
                        </div>
                    </li>
                </ul>
			...
			<div class="submit clearfix">
				...
				<input type="submit" id="SubmitLogin" name="SubmitLogin" class="button btn_primary btn-block" value="{l s='Authentication'}" />
			</div>
		</fieldset>
	</form>
    </div>
	...
	<form action="{$link->getPageLink('authentication', true, NULL, "back=$back")|escape:'html'}" method="post" id="new_account_form" class="std clearfix">
		<fieldset>
			...
			<div id="opc_account_form" style="display: block; ">
				...
				{if version_compare($smarty.const._PS_VERSION_,'1.5.6.0','>')}
                <p class="checkbox">
