...
<div class="pagenotfound">
	<div id="pagenotfound_wrap" class="center">
        {hook h='displayAnywhere' location="6" mod='steasycontent' caller='steasycontent'}
        <h1 class="heading">{l s='This page is not available'}</h1>
    	<p>
