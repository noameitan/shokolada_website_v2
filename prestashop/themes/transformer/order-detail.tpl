			...
			{if !isset($product.deleted)}
				...
				{if isset($product.customizedDatas)}
					<tr class="item">
						...
						<td>
                		<div class="mobile_table_title visible-phone">{l s='Reference'}</div>
						...
						<td>
                		<div class="mobile_table_title visible-phone">{l s='Quantity'}</div>
                        <div class="mobile_table_content">
                        <input class="order_qte_input"  name="order_qte_input[{$smarty.foreach.products.index}]" type="text" size="2" value="{$product.customizationQuantityTotal|intval}" /><label for="cb_{$product.id_order_detail|intval}"><span class="order_qte_span editable">{$product.customizationQuantityTotal|intval}</span></label>
                        </div>
                        </td>
						{if $order->hasProductReturned()}
							<td>
                    		<div class="mobile_table_title visible-phone">{l s='Returned'}</div>
                            <div class="mobile_table_content">
						...
						<td>
                    		<div class="mobile_table_title visible-phone">{l s='Total price'}</div>
                            <div class="mobile_table_content">
							<label class="price" for="cb_{$product.id_order_detail|intval}">
				...
				{if $product.product_quantity > $product.customizationQuantityTotal}
					<tr class="item">
						...
						<td>
                		<div class="mobile_table_title visible-phone">{l s='Quantity'}</div>
                        <div class="mobile_table_content"><input class="order_qte_input" name="order_qte_input[{$product.id_order_detail|intval}]" type="text" size="2" value="{$productQuantity|intval}" /><label for="cb_{$product.id_order_detail|intval}"><span class="order_qte_span editable">{$productQuantity|intval}</span></label>
                        </div>
                        </td>
						{if $order->hasProductReturned()}
							<td>
		...
		{foreach from=$discounts item=discount}
			<tr class="item">
				...
				<td>
                    <div class="mobile_table_title visible-phone">{l s='Quantity'}</div>
                    <div class="mobile_table_content">
                    <span class="order_qte_span editable">1</span>
                    </div>
                </td>
				{if $return_allowed}
				<td>&nbsp;</td>
				...
				<td>
            		<div class="mobile_table_title visible-phone">{l s='Total price'}</div>
                    <div class="mobile_table_content">
                    {if $discount.value != 0.00}-{/if}{convertPriceWithCurrency price=$discount.value currency=$currency}
                    </div>
                </td>
			</tr>
		{/foreach}
...
<div id="shipping-detail-content" class="table_block">
{if $order->getShipping()|count > 0}
	<table class="std">
		...
		<tbody>
			...
			<tr class="item">
				<td>
            		<div class="mobile_table_title visible-phone">{l s='Date'}</div>
                    <div class="mobile_table_content">{dateFormat date=$line.date_add full=0}</div>
                </td>
				<td>
            		<div class="mobile_table_title visible-phone">{l s='Carrier'}</div>
                    <div class="mobile_table_content">{$line.carrier_name}</div>
                </td>
				<td>
				...
				<td>
            		<div class="mobile_table_title visible-phone">{l s='Tracking number'}</div>
                    <div class="mobile_table_content">
