...
<div id="mailalerts_block_account">
	<h3 class="heading">{l s='My alerts' mod='mailalerts'}</h3>
	{if $mailAlerts}
		<div>
    ...
    <ul class="footer_links clearfix">
    	<li><a href="{$link->getPageLink('my-account', true)}" title="{l s='Back to Your Account' mod='mailalerts'}" rel="nofollow"><i class="icon-left icon-mar-lr2"></i>{l s='Back to Your Account' mod='mailalerts'}</a></li>
    	<li class="f_right"><a href="{$base_dir}" title="{l s='Home' mod='mailalerts'}" rel="nofollow"><i class="icon-home icon-mar-lr2"></i>{l s='Home' mod='mailalerts'}</a></li>
    </ul>
</div>