...
<div id="mywishlist">
	...
	<h3 class="heading">{l s='My wishlists' mod='blockwishlist'}</h3>
				...
				{section name=i loop=$wishlists}
					<tr id="wishlist_{$wishlists[i].id_wishlist|intval}">
						...
						<td class="wishlist_delete">
							<a href="javascript:;"onclick="return (WishlistDelete('wishlist_{$wishlists[i].id_wishlist|intval}', '{$wishlists[i].id_wishlist|intval}', '{l s='Do you really want to delete this wishlist ?' mod='blockwishlist' js=1}'));"><i class="icon-trash icon-small"></i></a>
						</td>
					</tr>
				{/section}
				</tbody>
    ...
    <ul class="footer_links clearfix">
    	<li><a href="{$link->getPageLink('my-account', true)}" title="{l s='Back to Your Account' mod='blockwishlist'}" rel="nofollow"><i class="icon-left icon-mar-lr2"></i>{l s='Back to Your Account' mod='blockwishlist'}</a></li>
    	<li class="f_right"><a href="{$base_dir}" title="{l s='Home' mod='blockwishlist'}" rel="nofollow"><i class="icon-home icon-mar-lr2"></i>{l s='Home' mod='blockwishlist'}</a></li>
    </ul>
</div>
