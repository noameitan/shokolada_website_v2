...
{assign var='productAttributeId' value=$product.id_product_attribute}
	{ldelim}
        ...
        "image_link":	 "{$link->getImageLink($product.link_rewrite, $product.id_image, 'small_default')|addslashes}",
		...
		"name":          "{$product.name|html_entity_decode:2:'UTF-8'|truncate:25:'...':true|escape:'htmlall'}",
        "full_name":     "{$product.name|html_entity_decode:2:'UTF-8'|escape:'htmlall'}",
