	...
	$('#sendEmail').click(function(){
		...
		if (name && email && !isNaN(id_product))
		{
			...
			$.ajax({
				...
				data: {action: 'sendToMyFriend', secure_key: '{/literal}{$stf_secure_key}{literal}', name: name, email: email, id_product: id_product, friend: unescape(JSON.stringify(datas).replace(/\\u/g, '%u'))},{/literal}{literal}
				dataType: "json",
				success: function(result) {
                    ...
                    if(typeof fancyMsgBox != 'undefined' && fancyMsgBox instanceof Function)
...
<li class="sendtofriend">
	<a id="send_friend_button" href="#send_friend_form"><i class="icon-mail icon-mar-lr2"></i>{l s='Send to a friend' mod='sendtoafriend'}</a>
</li>
