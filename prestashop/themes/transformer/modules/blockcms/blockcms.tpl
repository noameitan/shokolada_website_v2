...
{else}
	<!-- MODULE Block footer -->
	<section class="block_various_links block span3" id="block_various_links_footer">
        <a href="javascript:;" class="opener visible-phone">&nbsp;</a>
		<h4 class="title_block">{l s='Information' mod='blockcms'}</h4>
		<ul class="bullet footer_block_content">
            ...
            {if $display_poweredby}<li class="last_item"><a class="_blank" href="http://www.prestashop.com">{l s='Powered by' mod='blockcms'} {l s='Powered by' mod='blockcms'} PrestaShop&trade;</a></li>{/if}
		</ul>
	{$footer_text}
	</section>
	<!-- /MODULE Block footer -->
