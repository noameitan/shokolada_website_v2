...
<div id="favoriteproducts_block_account">
	<h2 class="heading">{l s='My favorite products.' mod='favoriteproducts'}</h2>
	{if $favoriteProducts}
		<div>
			...
			<div class="favoriteproduct clearfix">
				...
				<h6><a href="{$link->getProductLink($favoriteProduct.id_product, null, null, null, null, $favoriteProduct.id_shop)|escape:'htmlall':'UTF-8'}">{$favoriteProduct.name|escape:'htmlall':'UTF-8'}</a></h6>
    ...
    <ul class="footer_links clearfix">
    	<li><a href="{$link->getPageLink('my-account', true)}"><i class="icon-left icon-mar-lr2"></i>{l s='Back to Your Account' mod='favoriteproducts'}</a></li>
    	<li class="f_right"><a href="{$base_dir}"><i class="icon-home icon-mar-lr2"></i>{l s='Home' mod='favoriteproducts'}</a></li>
    </ul>
</div>