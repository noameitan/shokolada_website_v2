...
<h3 class="heading">{l s='My loyalty points' mod='loyalty'}</h3>
...
<ul class="footer_links clearfix">
	<li>
        <a href="{$link->getPageLink('my-account', true)|escape:'html'}" title="{l s='Back to Your Account' mod='loyalty'}" rel="nofollow"><i class="icon-left icon-mar-lr2"></i>{l s='Back to Your Account' mod='loyalty'}</a>
    </li>
	<li class="f_right">
        <a href="{$base_dir}" title="{l s='Home' mod='loyalty'}"><i class="icon-home icon-mar-lr2"></i>{l s='Home' mod='loyalty'}</a>
    </li>
</ul>