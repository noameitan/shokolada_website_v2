...
<h3 class="heading">{l s='Referral program' mod='referralprogram'}</h3>
...
<ul class="idTabs common_tabs li_fl clearfix hidden-phone">
...
<div id="referral_program_sheets" class="sheets mar_b2">

	<div id="idTab1" class="product_accordion">
        <a href="javascript:;" class="opener visible-phone">&nbsp;</a>
        <div class="product_accordion_title visible-phone">
            {l s='Sponsor my friends' mod='referralprogram'}
        </div>
        <div class="pa_content">
        
		<p class="bold">
            <strong>
                {if isset($currencySign)}
		...
		{if $canSendInvitations}
			...
			<form method="post" action="{$link->getModuleLink('referralprogram', 'program', [], true)|escape:'html'}" class="std">
				<table id="sponsor_my_friends_list" class="std">
				...
				<tbody>
					...
					<tr class="{if $smarty.section.friends.index % 2}item{else}alternate_item{/if}">
						...
						<td>
                        <div class="mobile_table_title visible-phone">{l s='Last name' mod='referralprogram'}</div>
                        <div class="mobile_table_content">
                        <input type="text" class="text" name="friendsLastName[{$smarty.section.friends.index}]" size="14" value="{if isset($smarty.post.friendsLastName[$smarty.section.friends.index])}{$smarty.post.friendsLastName[$smarty.section.friends.index]|escape:'htmlall':'UTF-8'}{/if}" />
                        </div>
                        </td>
						<td>
                        <div class="mobile_table_title visible-phone">{l s='First name' mod='referralprogram'}</div>
                        <div class="mobile_table_content">
                        <input type="text" class="text" name="friendsFirstName[{$smarty.section.friends.index}]" size="14" value="{if isset($smarty.post.friendsFirstName[$smarty.section.friends.index])}{$smarty.post.friendsFirstName[$smarty.section.friends.index]|escape:'htmlall':'UTF-8'}{/if}" />
                        </div>
                        </td>
						<td>
                        <div class="mobile_table_title visible-phone">{l s='E-mail' mod='referralprogram'}</div>
                        <div class="mobile_table_content">
                        <input type="text" class="text" name="friendsEmail[{$smarty.section.friends.index}]" size="20" value="{if isset($smarty.post.friendsEmail[$smarty.section.friends.index])}{$smarty.post.friendsEmail[$smarty.section.friends.index]|escape:'htmlall':'UTF-8'}{/if}" />
                        </div>
                        </td>
					</tr>
					{/section}
	...
	<div id="idTab2" class="product_accordion">
        <a href="javascript:;" class="opener visible-phone">&nbsp;</a>
        <div class="product_accordion_title visible-phone">
            {l s='Pending friends' mod='referralprogram'}
        </div>
        <div class="pa_content">
	...
	{if $pendingFriends AND $pendingFriends|@count > 0}
		...
		<form method="post" action="{$link->getModuleLink('referralprogram', 'program', [], true)|escape:'html'}" class="std">
			<table id="pending_friends_list" class="std">
			<thead class="hidden-phone">
				<tr>
					<th class="first_item">&nbsp;</th>
					<th class="item">{l s='Last name' mod='referralprogram'}</th>
			...
			{foreach from=$pendingFriends item=pendingFriend name=myLoop}
				<tr>
					...
					<td>
                        <div class="mobile_table_title visible-phone">{l s='Last invitation' mod='referralprogram'}</div>
                        <div class="mobile_table_content">
	...
	<div id="idTab3" class="product_accordion">
        <a href="javascript:;" class="opener visible-phone">&nbsp;</a>
        <div class="product_accordion_title visible-phone">
            {l s='Friends I sponsored' mod='referralprogram'}
        </div>
        <div class="pa_content">
	...
	{if $subscribeFriends AND $subscribeFriends|@count > 0}
		...
		<table id="friends_i_sponsord_list" class="std">
		<thead class="hidden-phone">
			<tr>
				<th class="first_item">&nbsp;</th>
				<th class="item">{l s='Last name' mod='referralprogram'}</th>
		...
		<tbody>
			...
			<tr>
				...
				<td>
                    <div class="mobile_table_title visible-phone">{l s='Last name' mod='referralprogram'}</div>
                    <div class="mobile_table_content">{$subscribeFriend.lastname|substr:0:22}</div>
                </td>
				<td>
                    <div class="mobile_table_title visible-phone">{l s='First name' mod='referralprogram'}</div>
                    <div class="mobile_table_content">{$subscribeFriend.firstname|substr:0:22}</div>
                </td>
				<td>
                    <div class="mobile_table_title visible-phone">{l s='E-mail' mod='referralprogram'}</div>
                    <div class="mobile_table_content">{$subscribeFriend.email}</div>
                </td>
				<td>
                    <div class="mobile_table_title visible-phone">{l s='Inscription date' mod='referralprogram'}</div>
                    <div class="mobile_table_content">{dateFormat date=$subscribeFriend.date_upd full=1}</div>
                </td>
			</tr>
			{/foreach}
		</tbody>
...
<ul class="footer_links clearfix">
	<li>
        <a href="{$link->getPageLink('my-account', true)|escape:'html'}" title="{l s='Back to Your Account' mod='referralprogram'}" rel="nofollow"><i class="icon-left icon-mar-lr2"></i>{l s='Back to Your Account' mod='referralprogram'}</a>
    </li>
	<li class="f_right">
        <a href="{$base_dir}" title="{l s='Home' mod='referralprogram'}"><i class="icon-home icon-mar-lr2"></i>{l s='Home' mod='referralprogram'}</a>
    </li>
</ul>
