...
<section class="block myaccount span3">
	...
	<div class="block_content footer_block_content">
		<ul class="bullet">
		...
		<p class="logout"><a href="{$link->getPageLink('index')|escape:'html'}?mylogout" title="{l s='Sign out' mod='blockmyaccountfooter'}" rel="nofollow">{l s='Sign out' mod='blockmyaccountfooter'}</a></p>
	</div>
</section>
<!-- /Block myaccount module -->