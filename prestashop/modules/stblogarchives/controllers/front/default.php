...
class StblogArchivesDefaultModuleFrontController extends ModuleFrontController
{
    ...
    public function getPath($year = null, $month = null)
    {
        ...
        $full_path = '<li typeof="v:Breadcrumb"><a rel="v:url" property="v:title" href="'.Tools::safeOutput($this->context->link->getModuleLink('stblog','default')).'" title="'.htmlentities($module_instanct->l('Blog'), ENT_NOQUOTES, 'UTF-8').'">'.htmlentities($module_instanct->l('Blog'), ENT_NOQUOTES, 'UTF-8').'</a></li>'.$pipe;
