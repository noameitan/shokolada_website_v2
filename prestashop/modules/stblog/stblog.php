...
class StBlog extends Module
{
    ...
    public static $moduleRoutes = array(
        'module-stblog-category' => array(
            'controller' =>  'category',
            'rule' =>        'module/stblog/category/{blog_id_category}-{rewrite}',
            'keywords' => array(
        ...
        'module-stblog-article' => array(
            'controller' =>  'article',
            'rule' =>        'module/stblog/{id_blog}_{rewrite}.html',
            'keywords' => array(
	...
	public function install()
	{
        $res = $this->installDb() &&
            ...
            Configuration::updateValue('ST_BLOG_META_TITLE', array('1'=>'Prestashop Blog')) &&
            Configuration::updateValue('ST_BLOG_META_KEYWORDS', array('1'=>'Prestashop Blog')) &&
            Configuration::updateValue('ST_BLOG_META_DESCRIPTION', array('1'=>'Prestashop Blog')) &&
            ...
            Configuration::updateValue('ST_BLOG_RELATED_ITEMS', 4) &&
