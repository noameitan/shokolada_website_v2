...
class StBlogCategory extends ObjectModel
{
	...
	/**
	  * Recursively add specified StBlogCategory childs to $toDelete array
	  *
	  ...
	  */
	protected function recursiveDelete(&$to_delete, $id_st_blog_category)
	{
	 	if (!is_array($to_delete) || !$id_st_blog_category)
		...
		{
			$to_delete[] = (int)$row['id_st_blog_category'];
			$this->recursiveDelete($to_delete, (int)$row['id_st_blog_category']);
		}
	}
