...
<section id="new-products_block_center{$smarty.capture.column_slider}" class="block products_block {if !$column_slider} section {/if} {if $hide_mob} hidden-phone {/if}">
    ...
    //<![CDATA[
    var new_itemslider_options{$smarty.capture.column_slider};
    //]]>
    </script>
	{if isset($products) AND $products}
    <div id="new-itemslider{$smarty.capture.column_slider}" class="flexslider">
        {if $column_slider}
    ...
    {literal}
    jQuery(function($) {
        new_itemslider_options{/literal}{$smarty.capture.column_slider}{literal} = {
    		...
    		controlNav: false,
    		controlsContainer: "#new-itemslider{/literal}{$smarty.capture.column_slider}{literal} .nav_top_right",
    		itemWidth: 260,
        ...
        $('#new-itemslider{/literal}{$smarty.capture.column_slider}{literal} .sliderwrap').flexslider(new_itemslider_options{/literal}{$smarty.capture.column_slider}{literal});
        var new_flexslider_rs{/literal}{$smarty.capture.column_slider}{literal};
        $(window).resize(function(){
            clearTimeout(new_flexslider_rs{/literal}{$smarty.capture.column_slider}{literal});
            var rand_s = parseInt(Math.random()*200 + 300);
            new_flexslider_rs{/literal}{$smarty.capture.column_slider}{literal} = setTimeout(function() {
                ...
                var flexslide_object = $('#new-itemslider{/literal}{$smarty.capture.column_slider}{literal} .sliderwrap').data('flexslider');
