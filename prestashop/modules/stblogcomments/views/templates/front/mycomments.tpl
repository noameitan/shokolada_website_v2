...
<div id="stblogcomment">
	...
	<form method="post" action="{$link->getModuleLink('stblogcomments','mycomments')}" id="form_stblogcomments" enctype="multipart/form-data">
		<div class="clearfix mar_b1">
			...
			<div id="avatar_right">
                ...
                <input type="submit" name="submitAvatar" id="submitAvatar" value="{l s='Upload' mod='stblogcomments'}" class="button" />
                {if $avatar && !preg_match('/stblogcomments|_default_/', $avatar)}<a href="{$link->getModuleLink('stblogcomments','mycomments',['act'=>'delavatar'])}" class="button" title="{l s='Use default' mod='stblogcomments'}">{l s='Use default' mod='stblogcomments'}</a>{/if}
			</div>
		</div>
	</form>
    {if $comments}
    ...
    <ul class="footer_links clearfix">
    	<li><a href="{$link->getPageLink('my-account', true)|escape:'htmlall'}"><i class="icon-left icon-mar-lr2"></i>{l s='Back to Your Account' mod='stblogcomments'}</a></li>
    	<li class="f_right"><a href="{$base_dir|escape:'htmlall'}"><i class="icon-home icon-mar-lr2"></i>{l s='Home' mod='stblogcomments'}</a></li>
    </ul>
</div>
