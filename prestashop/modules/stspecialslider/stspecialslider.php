...
class StSpecialSlider extends Module
{
	...
	function install()
	{
		if (!parent::install() 
            ...
            || !Configuration::updateValue('ST_SPECIAL_SLIDER_ITEMS', 4)
    ...
    public function getContent()
	{
        ...
        $helper->fields_value['slider_nbr'] = Configuration::get('ST_SPECIAL_SLIDER_NBR');
        $helper->fields_value['slider_easing'] = Configuration::get('ST_SPECIAL_SLIDER_EASING');
        $helper->fields_value['slider_slideshow'] = Configuration::get('ST_SPECIAL_SLIDER_SLIDESHOW');
        $helper->fields_value['slider_s_speed'] = Configuration::get('ST_SPECIAL_SLIDER_S_SPEED');
        $helper->fields_value['slider_a_speed'] = Configuration::get('ST_SPECIAL_SLIDER_A_SPEED');
        $helper->fields_value['slider_pause_on_hover'] = Configuration::get('ST_SPECIAL_SLIDER_PAUSE_ON_HOVER');
        $helper->fields_value['slider_loop'] = Configuration::get('ST_SPECIAL_SLIDER_LOOP');
        $helper->fields_value['slider_move'] = Configuration::get('ST_SPECIAL_SLIDER_MOVE');
        $helper->fields_value['slider_items'] = Configuration::get('ST_SPECIAL_SLIDER_ITEMS');
        $helper->fields_value['soby'] = Configuration::get('ST_SPECIAL_SOBY');
        $helper->fields_value['hide_mob'] = Configuration::get('ST_SPECIAL_SLIDER_HIDE_MOB');
        
        $helper->fields_value['s_nbr_col'] = Configuration::get('ST_SPECIAL_S_NBR_COL');
        $helper->fields_value['s_easing_col'] = Configuration::get('ST_SPECIAL_S_EASING_COL');
        $helper->fields_value['s_slideshow_col'] = Configuration::get('ST_SPECIAL_S_SLIDESHOW_COL');
        $helper->fields_value['s_s_speed_col'] = Configuration::get('ST_SPECIAL_S_S_SPEED_COL');
        $helper->fields_value['s_a_speed_col'] = Configuration::get('ST_SPECIAL_S_A_SPEED_COL');
        $helper->fields_value['s_pause_on_hover_col'] = Configuration::get('ST_SPECIAL_S_PAUSE_ON_HOVER_COL');
        $helper->fields_value['s_loop_col'] = Configuration::get('ST_SPECIAL_S_LOOP_COL');
        $helper->fields_value['s_move_col'] = Configuration::get('ST_SPECIAL_S_MOVE_COL');
        $helper->fields_value['s_items_col'] = Configuration::get('ST_SPECIAL_S_ITEMS_COL');
        $helper->fields_value['s_soby_col'] = Configuration::get('ST_SPECIAL_S_SOBY_COL');
        $helper->fields_value['s_hide_mob_col'] = Configuration::get('ST_SPECIAL_S_HIDE_MOB_COL');
        
        $helper->fields_value['s_nbr_fot'] = Configuration::get('ST_SPECIAL_S_NBR_FOT');
        $helper->fields_value['s_soby_fot'] = Configuration::get('ST_SPECIAL_S_SOBY_FOT');
    ...
    protected function initForm()
	{
		...
		$helper->module = $this;
		$helper->name_controller = 'stspecialslider';
	...
	public function hookDisplayHome($params)
	{
	    ...
	    if (!$this->isCached('stspecialslider.tpl', $this->stGetCacheId(0)))
    	    if(!$this->_prepareHook(0))
                return false;
		return $this->display(__FILE__, 'stspecialslider.tpl', $this->stGetCacheId(0));
	}
    ...
    private function _prepareHook($col=0)
    {
        ...
        $order_by = 'price';
        $order_way = 'ASC';
        $soby = $col ? (int)Configuration::get('ST_SPECIAL_S_SOBY_COL') : (int)Configuration::get('ST_SPECIAL_SOBY');
        switch($soby)
        {
            case 1:
                $order_by = 'date_add';
        ...
        $items = Configuration::get('ST_SPECIAL_'.$pre.'_ITEMS'.$ext);
        ($items===false && $col) && $items = Configuration::get('ST_SPECIAL_SLIDER_ITEMS');
	...
	public function hookDisplayLeftColumn($params)
	{
	    ...
	    if (!$this->isCached('stspecialslider.tpl', $this->stGetCacheId(1)))
    	    if(!$this->_prepareHook(1))
                return false;
		return $this->display(__FILE__, 'stspecialslider.tpl', $this->stGetCacheId(1));
	}
    ...
    {
	    if (!$this->isCached('stspecialslider-footer.tpl', $this->getCacheId()))
	    {
            $nbr = Configuration::get('ST_SPECIAL_S_NBR_FOT');
            $nbr = $nbr ? (int)$nbr : 4;
                
            $order_by = 'price';
            $order_way = 'ASC';
            $soby = (int)Configuration::get('ST_SPECIAL_S_SOBY_FOT');
            switch($soby)
            {
                case 1:
                    $order_by = 'date_add';
		...
		return $this->display(__FILE__, 'stspecialslider-footer.tpl', $this->getCacheId());
    }
	...
	{
		$this->_clearCache('stspecialslider.tpl');
		$this->_clearCache('stspecialslider-footer.tpl');
		$this->_clearCache('stspecialslider.tpl',$this->stGetCacheId(0));
		$this->_clearCache('stspecialslider.tpl',$this->stGetCacheId(1));
    }
