...
<section id="related-products_block_center{$smarty.capture.column_slider}" class="block products_block {if !$column_slider} section {/if} {if $hide_mob} hidden-phone {/if}">
