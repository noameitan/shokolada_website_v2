<?php /* Smarty version Smarty-3.1.14, created on 2014-01-20 23:41:46
         compiled from "D:\wamp\www\1561\prestashop\themes\transformer\shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2959752dd981a787a70-12151566%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bb61230998cab6ca623cd5de218951d6d3fa6528' => 
    array (
      0 => 'D:\\wamp\\www\\1561\\prestashop\\themes\\transformer\\shopping-cart.tpl',
      1 => 1389102133,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2959752dd981a787a70-12151566',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52dd981c773054_29863825',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52dd981c773054_29863825')) {function content_52dd981c773054_29863825($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'D:\\wamp\\www\\1561\\prestashop\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
<h1 id="cart_title" class="heading"><?php echo smartyTranslate(array('s'=>'Shopping-cart summary'),$_smarty_tpl);?>
</h1>
...
;
	...
	<p style="display:none" class="warning"><?php echo smartyTranslate(array('s'=>'Your shopping cart is empty.'),$_smarty_tpl);?>
</p>
    <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'displayAnywhere','location'=>"11",'mod'=>'steasycontent','caller'=>'steasycontent'),$_smarty_tpl);?>
...
"><i class="icon-trash  icon-large"></i></a><?php }?>
                </div>
				</td>
			</tr>
		<?php } ?>
...
<?php }?>
			...
			<?php if ($_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value<=0&&!isset($_smarty_tpl->tpl_vars['virtualCart']->value)){?>
				<tr class="cart_total_delivery" style="<?php if (!isset($_smarty_tpl->tpl_vars['carrier']->value->id)||is_null($_smarty_tpl->tpl_vars['carrier']->value->id)){?>display:none;<?php }?>">
					<td class="color_666"><?php echo smartyTranslate(array('s'=>'Shipping'),$_smarty_tpl);?>
</td>
...
<?php }?></td>
			...
			<tr class="cart_total_price">
				<td class="color_666"><?php echo smartyTranslate(array('s'=>'Total (tax excl.)'),$_smarty_tpl);?>
</td>
			...
			<tr class="cart_total_tax">
				<td class="color_666"><?php echo smartyTranslate(array('s'=>'Total tax'),$_smarty_tpl);?>
</td>
			...
			<tr class="cart_total_price">
				<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value){?>
                <td class="color_666"><?php echo smartyTranslate(array('s'=>'Total'),$_smarty_tpl);?>
</td>
