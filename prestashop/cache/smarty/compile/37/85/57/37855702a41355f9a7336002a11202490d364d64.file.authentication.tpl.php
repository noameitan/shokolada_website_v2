<?php /* Smarty version Smarty-3.1.14, created on 2014-01-16 23:48:31
         compiled from "D:\wamp\www\1561\prestashop\themes\transformer\authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3256052d853af7de4d0-04144395%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '37855702a41355f9a7336002a11202490d364d64' => 
    array (
      0 => 'D:\\wamp\\www\\1561\\prestashop\\themes\\transformer\\authentication.tpl',
      1 => 1389102132,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3256052d853af7de4d0-04144395',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52d853b0db4406_34833577',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d853b0db4406_34833577')) {function content_52d853b0db4406_34833577($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'D:\\wamp\\www\\1561\\prestashop\\tools\\smarty\\plugins\\modifier.escape.php';
?>
		...
		<fieldset class="block">
			...
			<div class="form_content clearfix">
                ...
                <ul class="wrapper_block">
                    <li>
                        <label for="email_create" class="required"><em>*</em><?php echo smartyTranslate(array('s'=>'Email address'),$_smarty_tpl);?>
</label>
                        <div class="input-box">
...
<?php }?>" class="account_input input-text" />
                        </div>
                    </li>
                </ul>
			</div>
...
" /><?php }?>
				<input type="submit" id="SubmitCreate" name="SubmitCreate" class="button_large btn_primary btn-block" value="<?php echo smartyTranslate(array('s'=>'Create an account'),$_smarty_tpl);?>
" />
...
" method="post" id="login_form" class="std">
		<fieldset class="block">
			...
			<div class="form_content clearfix">
                <p class="mar_b1"><?php echo smartyTranslate(array('s'=>'If you have an account with us, please log in.'),$_smarty_tpl);?>
</p>
                <ul class="wrapper_block">
                    <li>
                        <label for="email" class="required"><em>*</em><?php echo smartyTranslate(array('s'=>'Email address'),$_smarty_tpl);?>
</label>
                        <div class="input-box">
...
<?php }?>" class="account_input input-text" />
                    ...
                    <li>
                        <label for="passwd" class="required"><em>*</em><?php echo smartyTranslate(array('s'=>'Password'),$_smarty_tpl);?>
</label>
                        <div class="input-box">
...
<?php }?>" class="account_input input-text" />
                ...
                <p class="required_note"><sup>*</sup> <?php echo smartyTranslate(array('s'=>'Required Fields'),$_smarty_tpl);?>
</p>
...
" /><?php }?>
				<input type="submit" id="SubmitLogin" name="SubmitLogin" class="button btn_primary btn-block" value="<?php echo smartyTranslate(array('s'=>'Authentication'),$_smarty_tpl);?>
" />
			</div>
		</fieldset>
	</form>
...
" />
				...
				<?php if (version_compare(@constant('_PS_VERSION_'),'1.5.6.0','>')){?>
                <p class="checkbox">
