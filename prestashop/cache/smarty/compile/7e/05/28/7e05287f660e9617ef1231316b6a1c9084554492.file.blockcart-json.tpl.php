<?php /* Smarty version Smarty-3.1.14, created on 2014-01-19 22:31:16
         compiled from "D:\wamp\www\1561\prestashop\themes\transformer\modules\blockcart\blockcart-json.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1147252dc3614af5366-94734468%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7e05287f660e9617ef1231316b6a1c9084554492' => 
    array (
      0 => 'D:\\wamp\\www\\1561\\prestashop\\themes\\transformer\\modules\\blockcart\\blockcart-json.tpl',
      1 => 1389102133,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1147252dc3614af5366-94734468',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52dc3615298354_07240187',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52dc3615298354_07240187')) {function content_52dc3615298354_07240187($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'D:\\wamp\\www\\1561\\prestashop\\tools\\smarty\\plugins\\modifier.replace.php';
?>
{
"products": [
...
",
        "image_link":	 "<?php echo addslashes($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['id_image'],'small_default'));?>
",
...
<?php echo html_entity_decode(ob_get_clean(),2,'UTF-8')?><?php }?>",
		"name":          "<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(html_entity_decode($_smarty_tpl->tpl_vars['product']->value['name'],2,'UTF-8'),25,'...',true), ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
",
        "full_name":     "<?php echo mb_convert_encoding(htmlspecialchars(html_entity_decode($_smarty_tpl->tpl_vars['product']->value['name'],2,'UTF-8'), ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
",
