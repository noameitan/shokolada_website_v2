<?php /* Smarty version Smarty-3.1.14, created on 2014-01-07 16:42:22
         compiled from "D:\wamp\www\1561\prestashop\themes\transformer\modules\productscategory\productscategory.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52cc124e64c255_18273228',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52cc124e64c255_18273228')) {function content_52cc124e64c255_18273228($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'D:\\wamp\\www\\1561\\prestashop\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
<section id="productscategory-products_block_center" class="products_block block section">
	<h4 class="title_block"><span><?php echo count($_smarty_tpl->tpl_vars['categoryProducts']->value);?>
...
?>
        		<li class="ajax_block_product <?php if ($_smarty_tpl->tpl_vars['product']->first){?>first_item<?php }elseif($_smarty_tpl->tpl_vars['product']->last){?>last_item<?php }else{ ?>item<?php }?>">
                    <?php $_smarty_tpl->_capture_stack[0][] = array("new_on_sale", null, null); ob_start(); ?>
                        <?php if (isset($_smarty_tpl->tpl_vars['product']->value['new'])&&$_smarty_tpl->tpl_vars['product']->value['new']==1){?><span class="new"><i><?php echo smartyTranslate(array('s'=>'New','mod'=>'productscategory'),$_smarty_tpl);?>
</i></span><?php }?><?php if (isset($_smarty_tpl->tpl_vars['product']->value['on_sale'])&&$_smarty_tpl->tpl_vars['product']->value['on_sale']&&isset($_smarty_tpl->tpl_vars['product']->value['show_price'])&&$_smarty_tpl->tpl_vars['product']->value['show_price']&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?><span class="on_sale"><i><?php echo smartyTranslate(array('s'=>'Sale','mod'=>'productscategory'),$_smarty_tpl);?>
</i></span><?php }?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                    ...
                    <?php $_smarty_tpl->_capture_stack[0][] = array("pro_link", null, null); ob_start(); ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getProductLink($_smarty_tpl->tpl_vars['product']->value['id_product'],$_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['category'],$_smarty_tpl->tpl_vars['product']->value['ean13']), ENT_QUOTES, 'UTF-8', true);?>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
...
" /><?php echo Smarty::$_smarty_vars['capture']['new_on_sale'];?>
                    ...
                    <?php }?>
        			<p class="s_title_block <?php if (isset($_smarty_tpl->tpl_vars['sttheme']->value['length_of_product_name'])&&$_smarty_tpl->tpl_vars['sttheme']->value['length_of_product_name']){?> nohidden <?php }?>"><a href="<?php echo Smarty::$_smarty_vars['capture']['pro_link'];?>
